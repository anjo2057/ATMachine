...
class TestMain(unittest.TestCase):
    ...
    ## TC011
    # Testing the parser that process commands from a file
    def test_parser(self):
        ...
        # Test with a non-existing file: process_file calls sys.exit(1),
        # which raises SystemExit. Assert that happens and check the code.
        with self.assertRaises(SystemExit) as cm:
            bank.process_file("non_existing_file.txt")
